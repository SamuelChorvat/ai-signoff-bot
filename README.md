...
## Future Work
1. **Video test evidence via frame sampling (not full video analysis)**  
...
2. **Test evidence versioning and change detection**  
...
3. **Evidence quality and completeness metrics (non-blocking)**  
...
4. **Design intent comparison (e.g. Figma)**  
...
5. **AI-suggested missing Acceptance Criteria and edge cases**  
